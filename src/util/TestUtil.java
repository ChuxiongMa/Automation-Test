...
//		String ImageDest = System.getProperty(\"user.dir\")+\"/TestReport/Screenshots/";

		imageName = DriverApp.currentTest+DriverApp.currentTSID+year+"_"+date+"_"+(month+1)+"_"+day+"_"+min+"_" +sec;
