	...
	public static void startTesting(String filename,String testStartTime,String env,String rel)
	  {
	    ...
	    out.write("<html>\n");
	    out.write("<HEAD>\n");
	    out.write(" <TITLE>Cypress Automation Test results</TITLE>\n");
	     out.write("</HEAD>\n");
	    ...
	    out.write("<td width=150 align=left><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2.75> <img src='logo.png' align=right></img></td>\n"); 
			...
			// out.newLine();
		     ...
		     if(status.equalsIgnoreCase("Skipped") || status.equalsIgnoreCase("Skip"))
		    	...
		    	// out.write("<td width=40% align= center ><FONT COLOR=black FACE= Arial  SIZE=2><b><a href=file:///"+currentDir+"//"+currentSuiteName+"_TC"+tcid+"_"+testCaseName.replaceAll(" ", "_")+DriverScript.year+"_"+DriverScript.date+"_"+(DriverScript.month+1)+"_"+DriverScript.day+"_"+DriverScript.min+"_" +DriverScript.sec+".html>"+testCaseName+"</a></b></td>\n");
		    	 out.write("<td width=40% align= center ><FONT COLOR=black FACE= Arial  SIZE=2><b><a href="+currentSuiteName+"_TC"+tcid+"_"+testCaseName.replaceAll(" ", "_")+DriverApp.year+"_"+DriverApp.date+"_"+(DriverApp.month+1)+"_"+DriverApp.day+"_"+DriverApp.min+"_" +DriverApp.sec+".html>"+testCaseName+"</a></b></td>\n");
